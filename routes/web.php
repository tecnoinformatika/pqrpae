...
// Main Page Route
Route::get('/', [PqrController::class, 'index'])->name('index');
//  Route::get('/', [DashboardController::class, 'dashboardEcommerce'])->name('dashboard-ecommerce');
Route::group(['prefix' => 'pqrs'], function () {
    Route::get('pqr/{componente}', [PqrController::class, 'pqr'])->name('pqr');
    Route::post('crearPqr', [PqrController::class, 'crearPqr'])->name('crearPqr');
    Route::get('solicitudes', [PqrController::class, 'solicitudes'])->name('solicitudes');
});
